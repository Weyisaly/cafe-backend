...
func CafeRoutes(router *gin.Engine) {
	...
	router.GET("/cafe/foods/by-store", controller.GetByStoreIdFoods)
	router.GET("/cafe/foods/by-category", controller.GetFoodsByCategoryID)
	router.GET("/cafe/foods/filter", controller.GetFoodsFilter)
	router.GET("/cafe/foods/get", controller.GetFoods)
	router.GET("/cafe/foods/:id", controller.GetFoodByID)
	router.GET("/cafe/get/list", controller.GetCafe)
	router.GET("/cafe/get/:id", controller.GetCafeByID)
}
